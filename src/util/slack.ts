...
export function slackApi(endpoint: SlackApiEndpoint, body: SlackApiRequestBody) {
...
export function modal({ trigger_id, id, title, submit_text = 'Submit', blocks }: ModalArgs) {
  return {
    trigger_id,
    view: {
      type: 'modal',
